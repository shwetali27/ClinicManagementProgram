...
public class DatabaseDaoImpl implements DatabaseDao {
	...
	public void addPatient(PatientModel patientModel) throws ClassNotFoundException, SQLException {
		try {
			sql = "INSERT INTO PATIENT(patientId,patientName,patientNumber,patientAge) VALUES("+patientModel.getPatientId()+",'"+
					patientModel.getPatientName()+"','"+patientModel.getPatientNumber()+"',"+patientModel.getPatientAge()+")";
			stmt.executeUpdate(sql);
